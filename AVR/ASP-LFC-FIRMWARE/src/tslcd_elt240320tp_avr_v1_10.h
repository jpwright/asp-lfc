//http://www.gravitech.us/2tftcolcd240.html
...
void TSLCDOutDatBitsDir(uint8_t dir); //set direction of LCD data bit-by-bit
void TSLCDOutDatBits(unsigned short dat); //write byte to LCD bit-by-bit

uint8_t TSLCDInDatBits(void); //read byte from LCD bit-by-bit
